...
import (
	...
	rootchain "github.com/zenanetwork/iris/contracts/rootchain"

	slashmanager "github.com/zenanetwork/iris/contracts/slashmanager"

	stakemanager "github.com/zenanetwork/iris/contracts/stakemanager"

	stakinginfo "github.com/zenanetwork/iris/contracts/stakinginfo"

	statereceiver "github.com/zenanetwork/iris/contracts/statereceiver"
...
// GetZenaChainBlockAuthor provides a mock function with given fields: _a0
func (_m *IContractCaller) GetZenaChainBlockAuthor(_a0 *big.Int) (*common.Address, error) {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for GetZenaChainBlockAuthor")
	}
...
func (_m *IContractCaller) GetHeaderInfo(headerID uint64, rootChainInstance *rootchain.Rootchain, childBlockInterval uint64) (common.Hash, uint64, uint64, uint64, iristypes.IrisAddress, error) {
	...
	var r2 uint64
	var r3 uint64
	var r4 iristypes.IrisAddress
	var r5 error
	if rf, ok := ret.Get(0).(func(uint64, *rootchain.Rootchain, uint64) (common.Hash, uint64, uint64, uint64, iristypes.IrisAddress, error)); ok {
	...
	if rf, ok := ret.Get(4).(func(uint64, *rootchain.Rootchain, uint64) iristypes.IrisAddress); ok {
		r4 = rf(headerID, rootChainInstance, childBlockInterval)
	} else {
		if ret.Get(4) != nil {
			r4 = ret.Get(4).(iristypes.IrisAddress)
		}
	}
...
func (_m *IContractCaller) GetValidatorInfo(valID iristypes.ValidatorID, stakingInfoInstance *stakinginfo.Stakinginfo) (iristypes.Validator, error) {
	...
	var r0 iristypes.Validator
	var r1 error
	if rf, ok := ret.Get(0).(func(iristypes.ValidatorID, *stakinginfo.Stakinginfo) (iristypes.Validator, error)); ok {
		return rf(valID, stakingInfoInstance)
	}
	if rf, ok := ret.Get(0).(func(iristypes.ValidatorID, *stakinginfo.Stakinginfo) iristypes.Validator); ok {
		r0 = rf(valID, stakingInfoInstance)
	} else {
		r0 = ret.Get(0).(iristypes.Validator)
	}

	if rf, ok := ret.Get(1).(func(iristypes.ValidatorID, *stakinginfo.Stakinginfo) error); ok {
