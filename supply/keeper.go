...
import (
	...
	bank "github.com/zenanetwork/iris/bank"
...
func (k Keeper) GetModuleAddress(moduleName string) (addr hmTypes.IrisAddress) {
...
func (k Keeper) GetModuleAddressAndPermissions(moduleName string) (addr hmTypes.IrisAddress, permissions []string) {
	permAddr, ok := k.permAddrs[moduleName]
	if !ok {
...
func (k Keeper) SendCoinsFromModuleToAccount(
	ctx sdk.Context,
	senderModule string,
	recipientAddr hmTypes.IrisAddress,
	amt sdk.Coins,
) sdk.Error {
...
func (k Keeper) SendCoinsFromAccountToModule(
	ctx sdk.Context,
	senderAddr hmTypes.IrisAddress,
	recipientModule string,
	amt sdk.Coins,
) sdk.Error {
	// create the account if it doesn't yet exist
