...
func NewMsgSubmitProposal(content Content, initialDeposit sdk.Coins, proposer hmTypes.IrisAddress, validator hmTypes.ValidatorID) MsgSubmitProposal {
...
func (msg MsgSubmitProposal) GetSigners() []sdk.AccAddress {
	return []sdk.AccAddress{hmTypes.IrisAddressToAccAddress(msg.Proposer)}
}
...
func (msg MsgDeposit) GetSigners() []sdk.AccAddress {
	return []sdk.AccAddress{hmTypes.IrisAddressToAccAddress(msg.Depositor)}
}
...
func NewMsgVote(voter hmTypes.IrisAddress, proposalID uint64, option VoteOption, validator hmTypes.ValidatorID) MsgVote {
...
func (msg MsgVote) GetSigners() []sdk.AccAddress {
	return []sdk.AccAddress{hmTypes.IrisAddressToAccAddress(msg.Voter)}
}
