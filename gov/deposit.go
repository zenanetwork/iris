...
func (keeper Keeper) AddDeposit(ctx sdk.Context, proposalID uint64, depositorAddr hmTypes.IrisAddress, depositAmount sdk.Coins, validator hmTypes.ValidatorID) (sdk.Error, bool) {
