...
func (keeper Keeper) AddVote(ctx sdk.Context, proposalID uint64, voter hmTypes.IrisAddress, option types.VoteOption, validator hmTypes.ValidatorID) sdk.Error {
