...
func (k *Keeper) GetDividendAccountByAddress(ctx sdk.Context, address hmTypes.IrisAddress) (dividendAccount hmTypes.DividendAccount, err error) {
...
func (k *Keeper) CheckIfDividendAccountExists(ctx sdk.Context, userAddr hmTypes.IrisAddress) (ok bool) {
	store := ctx.KVStore(k.key)
...
func (k *Keeper) AddFeeToDividendAccount(ctx sdk.Context, userAddress hmTypes.IrisAddress, fee *big.Int) sdk.Error {
