...
type BaseAccount struct {
	Address       types.IrisAddress `json:"address" yaml:"address"`
...
func NewBaseAccountWithAddress(addr types.IrisAddress) BaseAccount {
	return BaseAccount{
		Address: addr,
	}
}
...
func (acc BaseAccount) GetAddress() types.IrisAddress {
	return acc.Address
}

// SetAddress - Implements sdk.Account.
func (acc *BaseAccount) SetAddress(addr types.IrisAddress) error {
