...
func (ar AccountRetriever) GetAccount(addr types.IrisAddress) (Account, error) {
...
// or decoding fails.
func (ar AccountRetriever) GetAccountWithHeight(addr types.IrisAddress) (Account, int64, error) {
...
func (ar AccountRetriever) EnsureExists(addr types.IrisAddress) error {
...
func (ar AccountRetriever) GetAccountNumberSequence(addr types.IrisAddress) (uint64, uint64, error) {
