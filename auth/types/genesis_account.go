...
import (
	...
	supplyExported "github.com/zenanetwork/iris/supply/exported"
	hmTypes "github.com/zenanetwork/iris/types"
)

// GenesisAccount is a struct for account initialization used exclusively during genesis
type GenesisAccount struct {
	Address       hmTypes.IrisAddress `json:"address" yaml:"address"`
...
func (gaccs GenesisAccounts) Contains(acc hmTypes.IrisAddress) bool {
