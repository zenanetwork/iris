...
// MinIrisFee is a free data retrieval call binding the contract method 0xfba58f34.
//
// Solidity: function minIrisFee() view returns(uint256)
func (_Stakemanager *StakemanagerCaller) MinIrisFee(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Stakemanager.contract.Call(opts, &out, "minIrisFee")
...
//
// Solidity: function minIrisFee() view returns(uint256)
func (_Stakemanager *StakemanagerSession) MinIrisFee() (*big.Int, error) {
	return _Stakemanager.Contract.MinIrisFee(&_Stakemanager.CallOpts)
}

// MinIrisFee is a free data retrieval call binding the contract method 0xfba58f34.
//
// Solidity: function minIrisFee() view returns(uint256)
func (_Stakemanager *StakemanagerCallerSession) MinIrisFee() (*big.Int, error) {
	return _Stakemanager.Contract.MinIrisFee(&_Stakemanager.CallOpts)
}
...
// TotalIrisFee is a free data retrieval call binding the contract method 0x9a8a6243.
//
// Solidity: function totalIrisFee() view returns(uint256)
func (_Stakemanager *StakemanagerCaller) TotalIrisFee(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Stakemanager.contract.Call(opts, &out, "totalIrisFee")
...
//
// Solidity: function totalIrisFee() view returns(uint256)
func (_Stakemanager *StakemanagerSession) TotalIrisFee() (*big.Int, error) {
	return _Stakemanager.Contract.TotalIrisFee(&_Stakemanager.CallOpts)
}

// TotalIrisFee is a free data retrieval call binding the contract method 0x9a8a6243.
//
// Solidity: function totalIrisFee() view returns(uint256)
func (_Stakemanager *StakemanagerCallerSession) TotalIrisFee() (*big.Int, error) {
	return _Stakemanager.Contract.TotalIrisFee(&_Stakemanager.CallOpts)
}
...
//
// Solidity: function confirmAuctionBid(uint256 validatorId, uint256 irisFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerTransactor) ConfirmAuctionBid(opts *bind.TransactOpts, validatorId *big.Int, irisFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "confirmAuctionBid", validatorId, irisFee, acceptDelegation, signerPubkey)
}

// ConfirmAuctionBid is a paid mutator transaction binding the contract method 0xc8b194a2.
//
// Solidity: function confirmAuctionBid(uint256 validatorId, uint256 irisFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerSession) ConfirmAuctionBid(validatorId *big.Int, irisFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.Contract.ConfirmAuctionBid(&_Stakemanager.TransactOpts, validatorId, irisFee, acceptDelegation, signerPubkey)
}

// ConfirmAuctionBid is a paid mutator transaction binding the contract method 0xc8b194a2.
//
// Solidity: function confirmAuctionBid(uint256 validatorId, uint256 irisFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerTransactorSession) ConfirmAuctionBid(validatorId *big.Int, irisFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.Contract.ConfirmAuctionBid(&_Stakemanager.TransactOpts, validatorId, irisFee, acceptDelegation, signerPubkey)
}
...
//
// Solidity: function stake(uint256 amount, uint256 irisFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerTransactor) Stake(opts *bind.TransactOpts, amount *big.Int, irisFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "stake", amount, irisFee, acceptDelegation, signerPubkey)
}

// Stake is a paid mutator transaction binding the contract method 0x028c4c67.
//
// Solidity: function stake(uint256 amount, uint256 irisFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerSession) Stake(amount *big.Int, irisFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.Contract.Stake(&_Stakemanager.TransactOpts, amount, irisFee, acceptDelegation, signerPubkey)
}

// Stake is a paid mutator transaction binding the contract method 0x028c4c67.
//
// Solidity: function stake(uint256 amount, uint256 irisFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerTransactorSession) Stake(amount *big.Int, irisFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.Contract.Stake(&_Stakemanager.TransactOpts, amount, irisFee, acceptDelegation, signerPubkey)
}

// StakeFor is a paid mutator transaction binding the contract method 0x4fdd20f1.
//
// Solidity: function stakeFor(address user, uint256 amount, uint256 irisFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerTransactor) StakeFor(opts *bind.TransactOpts, user common.Address, amount *big.Int, irisFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "stakeFor", user, amount, irisFee, acceptDelegation, signerPubkey)
}

// StakeFor is a paid mutator transaction binding the contract method 0x4fdd20f1.
//
// Solidity: function stakeFor(address user, uint256 amount, uint256 irisFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerSession) StakeFor(user common.Address, amount *big.Int, irisFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.Contract.StakeFor(&_Stakemanager.TransactOpts, user, amount, irisFee, acceptDelegation, signerPubkey)
}

// StakeFor is a paid mutator transaction binding the contract method 0x4fdd20f1.
//
// Solidity: function stakeFor(address user, uint256 amount, uint256 irisFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerTransactorSession) StakeFor(user common.Address, amount *big.Int, irisFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.Contract.StakeFor(&_Stakemanager.TransactOpts, user, amount, irisFee, acceptDelegation, signerPubkey)
}
...
//
// Solidity: function topUpForFee(address user, uint256 irisFee) returns()
func (_Stakemanager *StakemanagerTransactor) TopUpForFee(opts *bind.TransactOpts, user common.Address, irisFee *big.Int) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "topUpForFee", user, irisFee)
}

// TopUpForFee is a paid mutator transaction binding the contract method 0x63656798.
//
// Solidity: function topUpForFee(address user, uint256 irisFee) returns()
func (_Stakemanager *StakemanagerSession) TopUpForFee(user common.Address, irisFee *big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.TopUpForFee(&_Stakemanager.TransactOpts, user, irisFee)
}

// TopUpForFee is a paid mutator transaction binding the contract method 0x63656798.
//
// Solidity: function topUpForFee(address user, uint256 irisFee) returns()
func (_Stakemanager *StakemanagerTransactorSession) TopUpForFee(user common.Address, irisFee *big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.TopUpForFee(&_Stakemanager.TransactOpts, user, irisFee)
}
...
//
// Solidity: function updateMinAmounts(uint256 _minDeposit, uint256 _minIrisFee) returns()
func (_Stakemanager *StakemanagerTransactor) UpdateMinAmounts(opts *bind.TransactOpts, _minDeposit *big.Int, _minIrisFee *big.Int) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "updateMinAmounts", _minDeposit, _minIrisFee)
}

// UpdateMinAmounts is a paid mutator transaction binding the contract method 0xb1d23f02.
//
// Solidity: function updateMinAmounts(uint256 _minDeposit, uint256 _minIrisFee) returns()
func (_Stakemanager *StakemanagerSession) UpdateMinAmounts(_minDeposit *big.Int, _minIrisFee *big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.UpdateMinAmounts(&_Stakemanager.TransactOpts, _minDeposit, _minIrisFee)
}

// UpdateMinAmounts is a paid mutator transaction binding the contract method 0xb1d23f02.
//
// Solidity: function updateMinAmounts(uint256 _minDeposit, uint256 _minIrisFee) returns()
func (_Stakemanager *StakemanagerTransactorSession) UpdateMinAmounts(_minDeposit *big.Int, _minIrisFee *big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.UpdateMinAmounts(&_Stakemanager.TransactOpts, _minDeposit, _minIrisFee)
}
