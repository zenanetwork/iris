...
// IrisId is a free data retrieval call binding the contract method 0xfbc3dd36.
//
// Solidity: function irisId() view returns(bytes32)
func (_Slashmanager *SlashmanagerCaller) IrisId(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Slashmanager.contract.Call(opts, &out, "irisId")
...
//
// Solidity: function irisId() view returns(bytes32)
func (_Slashmanager *SlashmanagerSession) IrisId() ([32]byte, error) {
	return _Slashmanager.Contract.IrisId(&_Slashmanager.CallOpts)
}

// IrisId is a free data retrieval call binding the contract method 0xfbc3dd36.
//
// Solidity: function irisId() view returns(bytes32)
func (_Slashmanager *SlashmanagerCallerSession) IrisId() ([32]byte, error) {
	return _Slashmanager.Contract.IrisId(&_Slashmanager.CallOpts)
}
...
// SetIrisId is a paid mutator transaction binding the contract method 0xea0688b3.
//
// Solidity: function setIrisId(string _irisId) returns()
func (_Slashmanager *SlashmanagerTransactor) SetIrisId(opts *bind.TransactOpts, _irisId string) (*types.Transaction, error) {
	return _Slashmanager.contract.Transact(opts, "setIrisId", _irisId)
}

// SetIrisId is a paid mutator transaction binding the contract method 0xea0688b3.
//
// Solidity: function setIrisId(string _irisId) returns()
func (_Slashmanager *SlashmanagerSession) SetIrisId(_irisId string) (*types.Transaction, error) {
	return _Slashmanager.Contract.SetIrisId(&_Slashmanager.TransactOpts, _irisId)
}

// SetIrisId is a paid mutator transaction binding the contract method 0xea0688b3.
//
// Solidity: function setIrisId(string _irisId) returns()
func (_Slashmanager *SlashmanagerTransactorSession) SetIrisId(_irisId string) (*types.Transaction, error) {
	return _Slashmanager.Contract.SetIrisId(&_Slashmanager.TransactOpts, _irisId)
}
