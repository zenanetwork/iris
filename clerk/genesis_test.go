...
func (suite *GenesisTestSuite) TestInitExportGenesis() {
	...
	for i := range eventRecords {
		hAddr := hmTypes.BytesToIrisAddress([]byte(strconv.Itoa(simulation.RandIntBetween(r1, 1000, 100000))))
		hHash := hmTypes.BytesToIrisHash([]byte(strconv.Itoa(simulation.RandIntBetween(r1, 1000, 100000))))
