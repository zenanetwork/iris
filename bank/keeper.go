...
func (keeper Keeper) SetCoins(
	ctx sdk.Context, addr hmTypes.IrisAddress, amt sdk.Coins,
) sdk.Error {
...
func (keeper Keeper) SendCoins(
	ctx sdk.Context, fromAddr hmTypes.IrisAddress, toAddr hmTypes.IrisAddress, amt sdk.Coins,
) sdk.Error {
...
func (keeper Keeper) GetCoins(ctx sdk.Context, addr hmTypes.IrisAddress) sdk.Coins {
	acc := keeper.ak.GetAccount(ctx, addr)
	if acc == nil {
		return sdk.NewCoins()
	}
...
func (keeper Keeper) HasCoins(ctx sdk.Context, addr hmTypes.IrisAddress, amt sdk.Coins) bool {
